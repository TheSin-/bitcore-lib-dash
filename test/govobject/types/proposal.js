...
describe('Proposal', function() {
  ...
  it('should create new proposal', function() {
    ...
    proposal.payment_address = 'n28S35tqEMbt6vNad7A5K3mZ7vdn8dZ86X';
    proposal.payment_amount = 10;
    proposal.start_epoch = startDate;
    proposal.type = 1;
    proposal.url = "https://www.terracoin.io";
  ...
  it('should throw error if payment address is invalid', function() {
    ...
    proposal.end_epoch = endDate;
    proposal.name = 'TestProposal';
    proposal.payment_address = '1A601ttWnUq1'; // payment address must be > 26 characters
    proposal.payment_amount = 10;
    proposal.start_epoch = startDate;
    proposal.type = 1;
    proposal.url = "https://www.terracoin.io";
  ...
  it('should throw error if payment address is P2SH', function() {
    ...
    proposal.end_epoch = endDate;
    proposal.name = 'TestProposal';
    proposal.payment_address = '2N7FuwuUuoTBrDFdrAZ9KxBmtqMLxce9i1C';
    proposal.payment_amount = 10;
    proposal.start_epoch = startDate;
    proposal.type = 1;
    proposal.url = "https://www.terracoin.io";
    ...
    proposal2.name = 'Proposal-36-TerracoinATM';
    proposal2.payment_address = '342ftSRCvFHfCeFFBuz4xwbeqnDw6BGUey';
    proposal2.payment_amount = 1625.487;
    proposal2.start_epoch = startDate;
    proposal2.type = 1;
    proposal2.url = "https://services.terracoin.io/p/Proposal-36-TerracoinATM";
