  ...
  describe('GovObject - FromObject', function(){
    it('should cast a JSON Proposal into a Proposal Object', function(){
      ...
      var jsonProposal = {
        ...
        payment_address:'n28S35tqEMbt6vNad7A5K3mZ7vdn8dZ86X',
        payment_amount:10,
        type:1,
    ...
    it('should validate address', function(){
      var govObject = new GovObject;
      govObject._verifyAddress('n28S35tqEMbt6vNad7A5K3mZ7vdn8dZ86X','testnet').should.equal(true);
      govObject._verifyAddress('15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a2','livenet').should.equal(true);
      govObject._verifyAddress('15vkcKf7gB2&&3wLAnZLmbVuMasfajkshfjiiVDc1Nm4a2','livenet').should.equal(false);
      govObject._verifyAddress('knPDiVKe91sJasfajkshfjD1nQnnn5B6','testnet').should.equal(false);
      govObject._verifyAddress('15vkcKf7gB2&&3wLAnZLmbVuMa/sfajkshfjiiVDc1Nm4a2','livenet').should.equal(false);
      govObject._verifyAddress('15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a','livenet').should.equal(false);
      govObject._verifyAddress(' 15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a','livenet').should.equal(false);
      govObject._verifyAddress('15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a ','livenet').should.equal(false);
      govObject._verifyAddress('$15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a','livenet').should.equal(false);
      govObject._verifyAddress('n28S35tqEMbt6vNad7A5K3mZ7vdn8dZ86X','livenet').should.equal(false);
      govObject._verifyAddress('15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a2','testnet').should.equal(false);
    })
...
var expectedHex = "";
